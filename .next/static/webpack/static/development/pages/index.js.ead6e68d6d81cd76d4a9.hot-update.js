    ...
    value: function render() {
      ...
      return __jsx("div", {
        ...
        onClick: function onClick(item) {
          return _this2.handleSelectAllClick(index);
        },
        style: {
          margin: '2px'
        },
        ...
        color: "secondary",
        onClick: function onClick(item) {
          return _this2.handleFavoriteClick(index);
        },
        style: {
          margin: '2px'
        },
...
//# sourceMappingURL=index.js.ead6e68d6d81cd76d4a9.hot-update.js.map