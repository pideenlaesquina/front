...
var SearchCard = /*#__PURE__*/function (_Component) {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(SearchCard, [{
    ...
    key: "favoriteStores",
    value: function favoriteStores() {
      return [];
    }
  }, {
    key: "historyStores",
    value: function historyStores() {
      return [];
    }
  }, {
    key: "updateStoreList",
    value: function updateStoreList() {
      ...
      var favoriteStoresIds = this.favortieStores();
      var historyStoresIds = this.historyStores();
      var newStoresToShow = [];
      ...
      for (var i = 0; i < this.props.stores.length; i++) {
        ...
        if (!mustBeIncluded && this.state.onlyFavorites) {
          if (!favoriteStoresIds.includes(element.id)) {
            mustBeIncluded = false;
          }
        }

        if (!mustBeIncluded && this.state.onlyHistory) {
          if (!historyStoresIds.includes(element.id)) {
            mustBeIncluded = false;
          }
        }
...
//# sourceMappingURL=index.js.6f5250b36a559f78cf81.hot-update.js.map