...
var SearchCard = /*#__PURE__*/function (_Component) {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(SearchCard, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      if (prevProps.stores !== this.props.stores || JSON.stringify(prevState.categories) !== JSON.stringify(this.state.categories) || prevState.onlyHistory !== this.state.onlyHistory || prevState.categories !== this.state.categories) {
        alert(":)");
      }
    }
  }, {
...
//# sourceMappingURL=index.js.b2fc7e241b7bd00276e1.hot-update.js.map