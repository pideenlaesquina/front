...
var SearchCard = /*#__PURE__*/function (_Component) {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(SearchCard, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      console.log(prevState.categories !== this.state.categories);

      if (prevProps.stores !== this.props.stores || prevState.onlyFavorites !== this.state.onlyFavorites || prevState.onlyHistory !== this.state.onlyHistory || prevState.categories !== this.state.categories) {
        alert(":)");
      }
    }
  }, {
...
//# sourceMappingURL=index.js.f45ec5ed78de479131be.hot-update.js.map