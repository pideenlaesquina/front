...
var SearchCard = /*#__PURE__*/function (_Component) {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(SearchCard, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      if (prevProps.stores !== this.props.stores || JSON.stringify(prevState.categories) !== JSON.stringify(this.state.categories) || prevState.onlyHistory !== this.state.onlyHistory || prevState.onlyFavorites !== this.state.onlyFavorites) {
        alert(":)");
      }
    }
  }, {
...
//# sourceMappingURL=index.js.149ad975cf7f6f8dddf6.hot-update.js.map