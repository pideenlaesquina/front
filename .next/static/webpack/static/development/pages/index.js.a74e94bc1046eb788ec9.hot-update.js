  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Map, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      if (this.props.pos != null && this.props.stores != null) {
        if (prevProps.pos != this.props.pos || prevProps.stores !== this.props.stores) {
          var map = this.getMap(this.props.pos);
          var userMarker = this.placeUserMarker(map, this.props.pos); //this.removeAllStoreMarkers()
...
//# sourceMappingURL=index.js.a74e94bc1046eb788ec9.hot-update.js.map